            ...
            <div className='eventform' >
                ...
                <form className='eventform__form'>
                    ...
                    <div className="eventform__category__div">
                        ...
                        <select value={this.state.category} onChange={this.handleInfo} name="category"  className="eventfrom__category">
                            <option disabled value="" className='event__category__option'>please pick a category</option>
